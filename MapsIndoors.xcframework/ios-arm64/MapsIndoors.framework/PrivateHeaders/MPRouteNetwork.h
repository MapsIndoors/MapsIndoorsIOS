...
- (MPGraphEdge*) closestEdgeInGraphFromCoordinate:(CLLocationCoordinate2D)coordinate floor:(NSInteger)floor closestNode:(MPGraphNode*_Nullable*_Nullable)closestNode closestCoordinate:(MPLocationCoordinate3D* _Nullable)closestCoordinate accessTokens:(nullable NSSet<NSString*>*)accessTokens;
