...
SWIFT_CLASS("_TtC16MapsIndoorsSwift18DirectionsRenderer")
@interface DirectionsRenderer : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_PROTOCOL("_TtP16MapsIndoorsSwift26DirectionsRendererDelegate_")
@protocol DirectionsRendererDelegate <NSObject>
- (void)floorDidChange:(NSInteger)floor;
@end
...
+ (void)setupRouting:(NSString * _Nonnull)graphId solutionId:(NSString * _Nonnull)solutionId completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
