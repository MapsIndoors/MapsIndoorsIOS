 ...
 */
@interface MPMapControl : NSObject<GMSMapViewDelegate, MPFloorSelectorDelegate, MPOfflineTileLayerDelegate, MPBuildingDelegate, MPInfoSnippetViewDelegate, MPRouteActionDelegate, MPLocationsProviderDelegate, MPVenueProviderDelegate, MPRoutingProviderDelegate, MPAppDataProviderDelegate, MPPositionProviderDelegate, MPSolutionProviderDelegate>
 ...
 * App data provider.
 */
@property MPAppDataProvider* appDataProvider;
/**
 * Solution provider.
 */
...
- (void)setupMapWith:(MPLocationsProvider*)locationsProvider
             ...
             appData:(MPAppDataProvider*)appDataProvider;
/**
