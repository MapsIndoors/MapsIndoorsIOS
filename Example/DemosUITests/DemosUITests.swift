...
class DemosUITests: XCTestCase {
    ...
    func testSet1() {
        ...
        app.tables.staticTexts["Show leg 0, all steps"].tap()
        wait(app)
        app.navigationBars.buttons.firstMatch.tap()
        wait(app)
        app.navigationBars.buttons.firstMatch.tap()
        ...
        app.navigationBars.buttons.firstMatch.tap()
        wait(app)
        app.tables/*@START_MENU_TOKEN@*/.staticTexts["Search Map Demo"]/*[[".cells.staticTexts[\" Search Map Demo\"]",".staticTexts[\" Search Map Demo\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        wait(app)
