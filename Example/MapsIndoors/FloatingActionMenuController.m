...
- (void) setupFloatingActionBtn {
    ...
    _initTop = 180;
    MDButton *restRoomBtn = [[MDButton alloc] initWithFrame:CGRectMake(0, 0, 40, 40) type:FloatingAction rippleColor:[UIColor appLightPrimaryColor]];
    restRoomBtn.tag = 0;
    [restRoomBtn addTarget:self action:@selector(getNearest:) forControlEvents:UIControlEventTouchDown];
    MDButton *stairsBtn = [[MDButton alloc] initWithFrame:CGRectMake(0, 0, 40, 40) type:FloatingAction rippleColor:[UIColor appLightPrimaryColor]];
    stairsBtn.tag = 1;
    [stairsBtn addTarget:self action:@selector(getNearest:) forControlEvents:UIControlEventTouchDown];
    MDButton *entranceBtn = [[MDButton alloc] initWithFrame:CGRectMake(0, 0, 40, 40) type:FloatingAction rippleColor:[UIColor appLightPrimaryColor]];
    entranceBtn.tag = 2;
    [entranceBtn addTarget:self action:@selector(getNearest:) forControlEvents:UIControlEventTouchDown];
    MDButton *nearestBtn = [[MDButton alloc] initWithFrame:CGRectMake(0, 0, 60, 60) type:FloatingAction rippleColor:[UIColor colorWithWhite:255 alpha:.2f]];
