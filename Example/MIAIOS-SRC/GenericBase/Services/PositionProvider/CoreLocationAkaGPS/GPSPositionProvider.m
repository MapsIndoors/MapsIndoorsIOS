...
- (NSString*) debugInfo {
    ...
    [parts addObject: [NSString stringWithFormat:@"<GPSPositionProvider %p>", self] ];
    [parts addObject: [NSString stringWithFormat:@".enabled = %@", @(self.locationServicesEnabled)]];
    [parts addObject: [NSString stringWithFormat:@".active = %@", @(self.locationServicesActive)]];
    [parts addObject: [NSString stringWithFormat:@".auth = %@", @(self.authorizationStatus)]];
    [parts addObject: [NSString stringWithFormat:@".position = %@", self.latestPositionResult.geometry.latLngString]];
    [parts addObject: [NSString stringWithFormat:@".heading = %@", self.latestPositionResult.headingAvailable ? @(self.latestPositionResult.getHeadingDegrees) : @"N/A"]];
    [parts addObject: [NSString stringWithFormat:@".accuracy = %@", @(self.latestPositionResult.getProbability)]];

    return [NSString stringWithFormat:@"\n %@\n", [parts componentsJoinedByString:@"\n "]];
}

@synthesize enableDebugInfo = _enableDebugInfo;
@synthesize backgroundLocationUpdates = _backgroundLocationUpdates;
