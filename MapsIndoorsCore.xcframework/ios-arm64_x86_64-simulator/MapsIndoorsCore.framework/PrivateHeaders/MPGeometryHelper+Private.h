...
/**
 ...
 - Parameter p1: start of 1st linesegment
 - Parameter p2: end of 1st linesegment
 - Parameter p3: start of 2nd linesegment
 - Parameter p4: end of 2nd linesegment
 - Parameter pIntersection: optional receiver of intersection point.
 - Returns: YES if linesegments intersect, else NO
 */
