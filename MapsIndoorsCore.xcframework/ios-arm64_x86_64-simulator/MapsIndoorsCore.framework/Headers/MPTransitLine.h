 ...
 */
@property (nonatomic, strong, nullable, readonly) NSString<Optional>* short_name;

/**
 The color commonly used in signage for this transit line. The color will be specified as a hex string such as: #FF0033.
 */
@property (nonatomic, strong, nullable, readonly) NSString<Optional>* color;

/**
 An array of TransitAgency objects that each provide information about the operator of the line.
 */
@property (nonatomic, strong, nullable, readonly) NSArray<MPTransitAgency*><MPTransitAgency>* agencies;
 ...
 */
@property (nonatomic, strong, nullable, readonly) NSString<Optional>* icon;

/**
 Color of text commonly used for signage of this line. The color will be specified as a hex string.
 */
@property (nonatomic, strong, nullable, readonly) NSString<Optional>* text_color;

/**
 Type of vehicle used on this line. This may include the following properties:
 */
@property (nonatomic, strong, nullable, readonly) MPTransitVehicle<Optional>* vehicle;
