...
@interface MPLiveUpdateInternal : NSObject <MPLiveUpdate>

/// Get the Topic of the Live Update.
@property (nonatomic, strong, readonly) id<MPLiveUpdateTopic> topic;
...
@property (nonatomic, copy, readonly) NSString *originSourceId;
...
// Used in tests
+ (MPLiveUpdateInternal*)liveUpdateWithDictionary:(NSDictionary<NSString *, id> *)dict topic:(nullable NSString*)topic;
