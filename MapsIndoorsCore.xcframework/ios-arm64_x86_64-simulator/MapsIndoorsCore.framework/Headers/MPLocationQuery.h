...
/**
 Venue filter. Supports the venue key provided in MPVenue.administrativeId and MPLocation.venue
 */
...
/**
 Order by "relevance", "name", "roomId", "venue", "building", "floorIndex". Default is "relevance".
 */
...
/**
 Floor filter. Supports the floor index provided in MPMapControl.currentFloor and MPLocation.floorIndex
 */
